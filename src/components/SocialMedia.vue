<template>
    <div id="social-media" class="w-full h-auto space-x-3 pt-1 text-2xl text-primary dark:text-white">
        <a class="fa fa-instagram transition duration-200 ease-in-out hover:-translate-y-1" href="http://instagram.com/gamanathor" target="_blank" rel="noopener noreferrer"></a>
