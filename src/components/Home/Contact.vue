...
<template>
    <div id="contacto" class="w-full py-4 px-8 flex flex-col items-center space-y-4">
        ...
        <div class="w-full flex gap-2 items-center justify-center text-white">
            <div class="w-1/4 flex flex-col items-center justify-center bg-quaternary dark:bg-tertiary p-6 rounded-lg border-2 border-transparent hover:bg-transparent hover:border-primary hover:text-primary dark:hover:bg-transparent dark:hover:border-tertiary dark:hover:text-white transition-all ease-in-out duration-300">
                <i class="fa fa-envelope mr-2 text-3xl"/>
                <p class="text-gray-400">dereck.pavez@outlook.com</p>
                <a href="mailto:dereck.pavez@outlook.com" target="_blank" rel="noopener noreferrer">
                    Enviar un mensaje
                </a>
            </div>
            <div class="w-1/4 flex flex-col items-center justify-center bg-quaternary dark:bg-tertiary p-6 rounded-lg border-2 border-transparent hover:bg-transparent hover:border-primary hover:text-primary dark:hover:bg-transparent dark:hover:border-tertiary dark:hover:text-white transition-all ease-in-out duration-300">
                ...
                <a href="https://www.linkedin.com/in/dereck-pavez/" target="_blank" rel="noopener noreferrer">
                    Enviar un mensaje
                </a>
            </div>
        </div>
